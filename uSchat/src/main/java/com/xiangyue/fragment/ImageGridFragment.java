...
import com.xiangyue.act.BuildConfig;
import com.xiangyue.act.R;
import com.xiangyue.act.RecorderVideoActivity;
import com.xiangyue.weight.ImageCache;
import com.xiangyue.weight.ImageResizer;
import com.xiangyue.weight.RecyclingImageView;
import com.xiangyue.weight.Utils;
import com.xiangyue.weight.VideoEntity;

import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

public class ImageGridFragment extends Fragment implements OnItemClickListener, OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // ImageView img_back_common_actionbar = (ImageView) v
        // .findViewById(R.id.img_back_common_actionbar);
        // img_back_common_actionbar.setVisibility(View.VISIBLE);
        // img_back_common_actionbar.setOnClickListener(this);
        LinearLayout liner_back = (LinearLayout) v.findViewById(R.id.liner_back);
        liner_back.setOnClickListener(new OnClickListener() {
            @Override
...
//                holder.tvDur.setText(com.xiangyue.weight.DateUtils.formatDateYYYYMMDDHHMM(entty.duration));
                BigDecimal bigDecimal = new BigDecimal((float) entty.size / (1024 * 1024));
                double actSize = bigDecimal.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
                holder.tvSize.setText(actSize + "M");
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.rl_common_actionbar_back) {
            getActivity().finish();
        } else {
        }
    }
