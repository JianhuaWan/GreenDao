...
/**
 * author：wanjianhua on 2017/2/24 23:06
 * email：1243381493@qq.com
 */
public class ZoomScroVie extends ScrollView {

    public ZoomScroVie(Context context) {
        super(context);
    }

    public ZoomScroVie(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ZoomScroVie(Context context, AttributeSet attrs, int defStyleAttr) {
