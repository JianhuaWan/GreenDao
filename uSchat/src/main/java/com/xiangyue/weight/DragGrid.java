...
public class DragGrid extends GridView {
     ...
     * 每个ITEM之间的水平间距
     */
    private int mHorizontalSpacing = 8;
    /**
     * 每个ITEM之间的竖直间距
     */
...
//                }
                ...
                dragTextView.setTextSize(10f);
                dragTextView.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.MATCH_PARENT));
    ...
    public void startDrag(Bitmap dragBitmap, int x, int y) {
        stopDrag();
        windowParams = new WindowManager.LayoutParams(-1, 4);// 获取WINDOW界面的
        ...
        this.windowParams.format = PixelFormat.TRANSLUCENT | WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS;
        this.windowParams.windowAnimations = 0;
        if (Build.VERSION.SDK_INT >= 21) {
            this.windowParams.type = WindowManager.LayoutParams.TYPE_SYSTEM_ALERT;
        }
