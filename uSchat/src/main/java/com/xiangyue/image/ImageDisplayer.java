...
public class ImageDisplayer {
    ...
    private static final int THUMB_HEIGHT = 512;
    private int mScreenWidth;
    private int mScreenHeight;

    public synchronized static ImageDisplayer getInstance(Context context) {
        if (instance == null) {
    ...
    private void showDefault(ImageView iv) {
        iv.setImageResource(R.drawable.display_pictures_no);
    }
