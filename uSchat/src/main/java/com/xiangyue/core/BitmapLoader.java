...
import com.xiangyue.bitmap.BitmapCache;
import com.xiangyue.bitmap.BitmapDisplayConfig;
import com.xiangyue.bitmap.BitmapProcess;
import com.xiangyue.util.Utils;


public class BitmapLoader {
	private BitmapLoaderConfig mConfig;
	...
	private BitmapLoader(Context context) {
		mContext = context;
		mConfig = new BitmapLoaderConfig(context);
	 ...
	 * @return
	 */
	public static synchronized BitmapLoader create(Context ctx) {
		if (mBitmapLoader == null) {
			mBitmapLoader = new BitmapLoader(ctx.getApplicationContext());
		}
	 ...
	 * @param bitmap
	 */
	public BitmapLoader configLoadingImage(int resId) {
	 ...
	 * @param resId
	 */
	public BitmapLoader configLoadfailImage(int resId) {
	...
	/**
	 * 执行过此方法后,BitmapLoader的缓存已经失效,建议通过BitmapLoader.create()获取新的实例
	 * 
	 * @author fantouch
	 */
	...
	/**
	 * 关闭缓存 执行过此方法后,BitmapLoader的缓存已经失效,建议通过BitmapLoader.create()获取新的实例
	 * 
	 * @author fantouch
	 */
	...
	/**
	 * @title 配置信息
	 * @description BitmapLoader的配置信息
	 * @company 探索者网络工作室(www.tsz.net)
	 * @author michael Young (www.YangFuhai.com)
	 * @version 1.0
	 * @created 2012-10-28
	 */
	private class BitmapLoaderConfig {
		...
		public BitmapLoaderConfig(Context context) {
