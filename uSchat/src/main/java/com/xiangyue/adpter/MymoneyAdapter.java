...
import com.xiangyue.bean.PengBean;
...
public class MymoneyAdapter extends BaseAdapter {
	...
	public MymoneyAdapter(Context context, List<String> jsonBeans) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.money_item_main, null);
