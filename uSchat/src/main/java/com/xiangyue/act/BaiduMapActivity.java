...
public class BaiduMapActivity extends BaseActivity implements OnClickListener {
    ...
    private LinearLayout rl_common_actionbar_back;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rl_common_actionbar_back = (LinearLayout) findViewById(R.id.rl_common_actionbar_back);
        rl_common_actionbar_back.setOnClickListener(this);
...
//            mBaiduMap.setMyLocationConfigeration(new MyLocationConfiguration(mCurrentMode, true, null));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.rl_common_actionbar_back:
                finish();
                break;
