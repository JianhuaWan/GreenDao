...
import com.xiangyue.fragment.LoginWorkFragment;
import com.xiangyue.fragment.OnlineWorkFragment;
...
public class DayActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.img_situp:
                ...
                intent.setClass(DayActivity.this, DayintroduceActivity.class);
    ...
    private void changePerson() {
        Fragment f = new LoginWorkFragment();
        if (null == mFM)
    ...
    private void changeBussiness() {
        Fragment f = new OnlineWorkFragment();
        if (null == mFM)
