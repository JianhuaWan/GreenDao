//package com.xiangyue.widget.imageslider.Indicators;
//
...
//import com.xiangyue.widget.imageslider.Tricks.InfinitePagerAdapter;
//import com.xiangyue.widget.imageslider.Tricks.ViewPagerEx;
//
///**
// * Pager Indicator.
// */
...
//				.getInt(R.styleable.PagerIndicator_visibility, IndicatorVisibility.Visible.ordinal());
//
...
//
//		mDefaultSelectedColor = attributes
//				.getColor(R.styleable.PagerIndicator_selected_color, Color.rgb(255, 255, 255));
...
//		mDefaultSelectedHeight = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_height,
//				(int) pxFromDp(6));
//
//		mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_width,
//				(int) pxFromDp(6));
//		mDefaultUnSelectedHeight = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_height,
//				(int) pxFromDp(6));
//
...
//		mPadding_bottom = attributes
//				.getDimensionPixelSize(R.styleable.PagerIndicator_padding_bottom, (int) pxFromDp(0));
//
//		mSelectedPadding_Left = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_padding_left,
//				(int) mPadding_left);
//		mSelectedPadding_Right = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_padding_right,
//				(int) mPadding_right);
//		mSelectedPadding_Top = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_padding_top,
//				(int) mPadding_top);
//		mSelectedPadding_Bottom = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_padding_bottom,
//				(int) mPadding_bottom);
//
//		mUnSelectedPadding_Left = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_padding_left,
//				(int) mPadding_left);
...
//		mUnSelectedPadding_Top = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_padding_top,
//				(int) mPadding_top);
...
//		setDefaultSelectedPadding(mSelectedPadding_Left, mSelectedPadding_Top, mSelectedPadding_Right,
//				mSelectedPadding_Bottom, Unit.Px);
//		setDefaultUnSelectedPadding(mUnSelectedPadding_Left, mUnSelectedPadding_Top, mUnSelectedPadding_Right,
...
//		if (unit == Unit.DP) {
//			mSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left), (int) pxFromDp(top), (int) pxFromDp(right),
//					(int) pxFromDp(bottom));
//		} else {
//			mSelectedLayerDrawable.setLayerInset(0, (int) left, (int) top, (int) right, (int) bottom);
//
//		}
//	}
//
...
//		if (unit == Unit.DP) {
//			mUnSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left), (int) pxFromDp(top), (int) pxFromDp(right),
//					(int) pxFromDp(bottom));
//
//		} else {
//			mUnSelectedLayerDrawable.setLayerInset(0, (int) left, (int) top, (int) right, (int) bottom);
//
//		}
//	}
//
