...
import com.im.bean.Friend;
import com.im.bean.User;
import com.im.model.i.QueryUserListener;
...
public class UserModel extends BaseModel {
     ...
     * @param listener
     */
    public void queryUsersByNick(String object, int limit, final FindListener<User> listener) {
        BmobQuery<User> query = new BmobQuery<>();
        //去掉当前用户
        try {
            BmobUser user = BmobUser.getCurrentUser(getContext());
        ...
        query.addWhereContains("objectId", object);
        query.setLimit(limit);
        query.order("-createdAt");
        query.findObjects(getContext(), new FindListener<User>() {
            @Override
